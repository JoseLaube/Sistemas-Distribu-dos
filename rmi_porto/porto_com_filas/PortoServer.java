...
public class PortoServer implements IServico {
    ...
    public static void main(String[] args) {
        try {
            ...
            Registry registry = LocateRegistry.createRegistry(6061);
   ...
   @Override
    public synchronized Integer cadastrar_navio(String descricao, Integer capacidade) throws RemoteException {
    ...
    @Override
    public synchronized void remover_navio(Integer id) throws RemoteException {
        navios.remove(id);
        System.out.println("Navio removido ID: " + id);
    }

    @Override
    public synchronized String relatorio_navio() throws RemoteException {
    ...
    @Override
    public synchronized Integer cadastrar_carga(String descricao, Integer volume) throws RemoteException {
    ...
    @Override
    public synchronized void remover_carga(Integer id) throws RemoteException {
        cargas.remove(id);
    }

    @Override
    public synchronized String relatorio_carga() throws RemoteException {
    ...
    @Override
    public synchronized String relatorio_embarque() throws RemoteException {
